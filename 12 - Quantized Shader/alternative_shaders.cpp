...
int main() {
   ...
   QuantizedGouraudShader quantizedGouraudShader;
   quantizedGouraudShader.color = TGAColor(160,255,255,255);

   vector<int> quants = {3, 5, 7, 255};
